...
describe('routes : comments', () => {
  ...
  //guests
		...
		describe('POST /topics/:topicId/posts/:postId/comments/create', () => {
			it('should not create a new comment', done => {
				...
				request.post(options, (err, res, body) => {
					// #4
					Comment.findOne({ where: { body: 'What a great comment.' } })
						.then(comment => {
				...
				request.post(options, (err, res, body) => {
					Comment.findOne({ where: { body: 'What a great comment.' } })
						.then(comment => {
							...
							expect(comment.body).toBe('What a great comment.');
	...
	//Signed in user shouldn't delete another comment 

	describe('Signed in users should not delete another comment', () => {
		describe('POST /topics/:topicId/posts/:postId/comments/create', () => {
			beforeEach(done => {
				request.get(
					{
	...
	describe('admin user performing CRUD actions for on another user Comment', () => {
		...
		//Admin user should be able to delete content
